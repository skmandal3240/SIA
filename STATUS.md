...
| P1 — Action adapter | 60% | 1000-example dataset generator; real LoRA retrain needed on GPU |
...
| P4 — Memory | 80% | TokenCake + episodic + GraphRAG wired; `make p4-memory` |
| P5 — Swarm + distillation | 70% | N=2 swarm + MoS scaffold; `make swarm-p5` |
